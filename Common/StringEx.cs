...
namespace NetCore_Gateway
{
	public static class StringEx
	{
		...
		public static HashSet<T> FromStringWithSeparatorToHashSet<T>(char separator, string text, T defaultValue = default(T))
		{
		...
		public static SortedSet<T> FromStringWithSeparatorToSortedSet<T>(char separator, string text, T defaultValue = default(T))
		{
